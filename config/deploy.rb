...
role :web, "groupmy.com"                          # Your HTTP server, Apache/etc
role :app, "groupmy.com"                         # This may be the same as your `Web` server
role :db,  "groupmy.com"   , :primary => true # This is where Rails migrations will run
